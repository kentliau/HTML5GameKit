/**  
 *
 * @preserve PixelLab Resource Loader
...
function PxLoader(settings) {
    ...
    this.removeListener = function(listener) {
        ...
        for(var j = 0; j < progressListeners.length; j++) {
            if(progressListeners[j].callback === listener) {
                idx = j;
                break;
            }
        }
    ...
    var onProgress = function(resource, statusType) {
        ...
        //updated to not skip listeners if list is modified while looping
        for(var i = progressListeners.length - 1; i >= 0; i--) {
    ...
    var log = this.log = function(showAll) {
        ...
        if (window.console) window.console.log('PxLoader elapsed: ' + elapsedSeconds + ' sec');
